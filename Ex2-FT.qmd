...
::: {.fragment .escrita-estavel style="color: #dd35ff; font-family: 'Courier New', monospace; font-size: 1.4em;"}
...
::: {.fragment style="font-size: 1.35em;"}
...
::: {.fragment .escrita-estavel style="color: #00eeff; font-family: 'Courier New', monospace; font-size: 1em;"}
Então: $\displaystyle (j\omega)^{4} + 2 = [(j\omega)^{4} - 4(j\omega)^{3} - (j\omega)^{2} + 4(j\omega)]\cdot 1 + 4(j\omega)^{3} + (j\omega)^{2} - 4(j\omega) + 2$
:::
...
::: {.fragment style="font-size: 1.1em;"}
$$\displaystyle B\biggr|_{j\omega = 0} = \dfrac{4(j\omega)^{3} + (j\omega)^{2} - 4(j\omega) + 2}{(j\omega -4)(j\omega-1)(j\omega+1)} = \dfrac{2}{4} = \dfrac{1}{2} = 0,5$$
:::
:::
